						...
						<div className="bloco1">
							<section>
								...
								<Select
									...
									style={{ width: 270 }}
									options={[
										{ value: "Agente", label: "Agente (ADE)" },
										{ value: "Não", label: "Não" },
									]}
								/>
							</section>
							<section>
								<label htmlFor="cadPessoaData">Data de cadastro:</label>
								<Input type="date" name="date" id="date" />
							</section>

							<section>
								<label htmlFor="cadPessoa">Agente responsável:</label>
								<Select
									defaultValue="Selecione"
									required
									style={{ width: 270 }}
									options={[{ label: "Lista de agentes aparecerá aqui" }]}
								/>
							</section>
						</div>
					...
					<TabPane className="abas" tab="Dados pessoais" key={2}>
						...
						<div className="bloco2">
							...
							<section>
								...
								<Select
									defaultValue="Selecione a renda"
									style={{ width: 250 }}
									options={[
										{
											value: "Menos que R$ 1.000,00",
											label: "Menos que R$ 1.000,00",
										},
										{
											value: "Entre R$1.001,00 - R$2.500,00",
											label: "Entre R$1.001,00 - R$2.500,00",
										},
										{
											value: "Entre R$2.501,00 - R$5.000,00",
											label: "Entre R$2.501,00 - R$5.000,00",
										},
										{
											value: "Mais que R$5.000,00",
											label: "Mais que R$5.000,00",
										},
									]}
								/>
							</section>
					...
					<TabPane className="abas" tab="Logradouro residencial" key={3}>
						<div className="bloco3">
							...
							<section>
								...
								<Input
									id="complemento"
									placeholder="Apartamento, prédio, casa..."
								/>
							</section>
							<section>
							...
							<section>
								...
								<Select
									...
									options={[
										...
										{
											value: "ns de fatima",
											label: "Sede: Nossa Senhora de Fátima",
										},
										{
											value: "sagrada familia",
											label: "Sede: Sagrada Família",
										},
										{ value: "sao jose", label: "Sede: São José" },
										{ value: "sao mateus", label: "Sede: São Mateus" },
										{
											value: "pm lemos braga",
											label: "Sede: Padre Manoel Lemos Braga",
										},
									]}
								/>
							</section>
